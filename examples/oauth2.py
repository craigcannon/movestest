...
Moves = MovesClient('6T16sRbKVr0EQ2XBW5ac14ylTFeb4_IQ', 'Izf4WTw5c0EuqF2VXtp32K5AGdF5275g_PV7kbl0eJ66YrCCXK_z9Pfo7SO5MWMd')
        ...
        if segment['type'] == 'place':
            ...
            for activity in segment['activities']:
                for track_point in activity['trackPoints']:
                    ...
                    latLon.append(gpsPoint)
            #print "new lat %f" % latitude
            #print "new lon %f" % longitude
        res += '<hr>'
    return render_template('hi.html', latLon=latLon)
    # return res
